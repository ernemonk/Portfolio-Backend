...
Note: Credential vault and database browser live in the Config service (3007).
      This service reads credentials via the shared DB models when building connectors.
"""
